...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from YOLOv5.yolov5.models.common import AutoShape, DetectMultiBackend
    from YOLOv5.yolov5.models.yolo import Model
    from YOLOv5.yolov5.utils.downloads import attempt_download
    from YOLOv5.yolov5.utils.general import LOGGER, check_requirements, intersect_dicts, logging
    from YOLOv5.yolov5.utils.torch_utils import select_device
...
if __name__ == '__main__':
    ...
    from YOLOv5.yolov5.utils.general import cv2
